                    ...
                    <div class="sm:p-6 p-1 text-gray-900">
                        <section class="text-gray-600 body-font">
                            <div class="container px-5 py-8 mx-auto">
                                <FlashMessage />
                                <div
                                    class="sm:flex-row flex-col flex pl-4 my-4 lg:w-2/3 w-full mx-auto"
                                >
                                    <div>
                                        <input
                                            type="text"
                                    ...
                                    <Link
                                        ...
                                        class="sm:mt-0 mt-2 flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded"
                                    >
                                        顧客登録</Link
                                    >
                                </div>
