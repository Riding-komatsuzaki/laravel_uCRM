              ...
              <div class="container px-5 py-8 mx-auto">
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        <label for="memo" class="leading-7 text-sm text-gray-600">商品メモ</label>
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        ...
                        <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" class="ml-2 mb-1">
                          <label class="ml-2 mr-4">販売中</label>
                          <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="0" class="ml-2 mb-1">
